...
class CustomerAdmin(admin.ModelAdmin):
    model = Customer
    list_display = ['id', 'first_name', 'last_name', 'email', 'phone', 'address', 'city',
                    'country', 'image']
...
class VariationAdmin(admin.ModelAdmin):
    model = Variation
    list_display = ['id', 'product', 'title', 'sku', 'image', 'price', 'created_at', 'updated_at']
...
class OrderAdmin(admin.ModelAdmin):
    model = Order
    list_display = ['id', 'products', 'amounts', 'customer', 'owner', 'total_price', 'total_tax', 'payment', 'status',
