...
class UserSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = tuple(User.REQUIRED_FIELDS) + (
            User._meta.pk.name,
            User.USERNAME_FIELD, 'country', 'city', 'first_name', 'last_name', 'phone', 'address', 'company',
            'company_id', 'avatar', 'website'
        )
        read_only_fields = (User.USERNAME_FIELD, 'avatar', )
...
class UserCreateSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = User
        fields = tuple(User.REQUIRED_FIELDS) + (
            User.USERNAME_FIELD, User._meta.pk.name, 'password', 'country', 'city', 'first_name', 'last_name', 'phone',
