...
export class ApiService {
  ...
  createPassword = {
    post: (token, password, store) => this.request
      .post({token: token, password: password, store: store})
      .url('/api/v1.0/auth/users/createpassword')
  };

  checkActiveUser = {
    post: (token) => this.request
      .post({token: token})
      .url('/api/v1.0/auth/users/check-user')
  };
  ...
  uploadAvatar = {
    post: (file) => this.request
      .post(file)
      .url('/api/v1.0/auth/users/upload-avatar/')
      .auth(),
  };

  uploadCompanyAvatar = {
    post: (file, id) => this.request
      .post(file)
      .url('/api/v1.0/company/{}/upload-avatar/', id)
      .auth(),
  };
  ...
  member = {
    get: () => this.request
      .get()
      .url('/api/v1.0/member/entity')
      .auth(),
    searchByArg: () => this.request
      .get()
      .url('/api/v1.0/member/search')
      .auth(),
    post: (country) => this.request
      .post(country)
      .url('/api/v1.0/member/entity')
    ...
    update: (customer) => this.request
      .put()
      .url('/api/v1.0/member/{}/update', customer.id)
      .payload(customer)
      .auth(),
    delete: (id) => this.request
      .delete()
      .url('/api/v1.0/member/{}/delete', id)
      .auth(),
  };
  ...
  product = {
    ...
    post: (product) => this.request
      ...
      .url('/api/v1.0/product/entity')
      .auth(),
    update: (product, id) => this.request
      .put()
      .url('/api/v1.0/product/{}/update', id)
      .payload(product)
      .auth(),
     delete: (id) => this.request
      .delete()
  ...
  variationAttribute = {
    get: (typeId) => this.request
    .get()
    .url('/api/v1.0/product/{}/variationattribute', typeId)
    .auth(),
  }
  ...
  company = {
    ...
    getStuffByCompanyId: (id) => this.request
      ...
      .auth(),
    getCompanyById: (id) => this.request
      .get()
      .url('/api/v1.0/company/entity/{}', id)
      .auth(),
    ...
    post: (stuff) => this.request
      ...
      .url('/api/v1.0/company/entity')
      .auth(),
    update: (company) => this.request
      .put()
      .url('/api/v1.0/company/{}/update', company.id)
      .payload(company)
      .auth(),
    delete: (id) => this.request
      .delete()
      .url('/api/v1.0/company/{}/delete', id)
      .auth(),
  };
